...
console.log(blue,   "Bun Upgrade!\n");
console.log(yellow, "Elige tu Sistema Operativo:");
...
rl.question("", (option) => {
    ...
    if (option === "1" && os.platform() !== "win32") {
        ...
        console.log(yellow, "Instalando Bun en macOS/Linux/WSL...!!!\n");
    ...
    // Condición para Windows y la opción 2.
        ...
        console.log(yellow, "Instalando Bun en Windows...!!!\n");
